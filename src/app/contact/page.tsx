          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 text-base text-indigo-50 max-w-3xl">
                Feel free to contact us for queries related to upcoming events
                and tournaments.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">Tarun Snagha Club, Pandu</span>
                </dd>
                <dt>
                  <span className="sr-only">Phone number</span>
                </dt>
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">+91 7086255583</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">durlavk98@gmail.com</span>
                </dd>
              </dl>
